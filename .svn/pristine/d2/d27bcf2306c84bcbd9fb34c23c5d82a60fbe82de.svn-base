<%@ Page Title="" Language="C#" MasterPageFile="~/MasterCustomer.master" AutoEventWireup="true" CodeFile="ScientificTopicsListForAuthorPage.aspx.cs" Inherits="ScientificTopicsListForAuthorPage" %>
    ...
    <div id="User" style="width: 100%; padding: 1px 15px; position: relative;">
        ...
        <div class="row">
            <div class="form-group">
                <div class="col-sm-8" style="padding-left:28px;">
                    <asp:TextBox runat="server" ID="txtTitle" placeholder="Nhập tên bài báo hoặc tóm tắt" class="form-control" />
                </div>
                <div class="col-sm-4">
