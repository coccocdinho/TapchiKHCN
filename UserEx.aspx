<%@ Page Title="" Language="C#" MasterPageFile="~/MasterCustomer.master" AutoEventWireup="true" CodeFile="UserEx.aspx.cs" Inherits="UserEx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        var Popup = {
            UsersDetails: { popupName: "UsersDetails", popupTitle: "Quản lý nhân sự", popupWidth: 800, popupHeight: 650, popupScrollable: "yes", url: "UserExDetail.aspx", ShowPopup: ShowPopup, ClosePopup: ClosePopup },
        }
        ...
        function OpenUpdate(keyid) {
            ...
            var url = "UserExDetail.aspx?KeyId=" + keyid;
            var dialogTitle = "Cập nhật nhân sự";
        ...
        function OpenDelete(keyid) {
            ...
            if (!isOk) return;
            var _url = "Handler/DeleteUserExDetail.ashx/Process";
                    ...
                    <asp:Repeater runat="server" ID="rpList" ClientIDMode="Static">
                            ...
                            <table class="table table-bordered invoiceRelease">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center; vertical-align: middle;">Cơ quan</th>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="width: auto; text-align: center;"><%# Eval("PositionName") %></td>
                                <td style="width: auto; text-align: center;"><%# Eval("CompanyName") %></td>
