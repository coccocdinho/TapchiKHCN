...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="infomation">
                ...
                <asp:Repeater runat="server" ID="rptListTopic">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%# Eval("Author") %><%# Eval("SameAuthorName").ToString().Length > 0 ? ", "+ Eval("SameAuthorName") : "" %></td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
                            </tbody>
        ...
        <cc1:CollectionPager ID="pager" runat="server" PageSize="10" BackText="« Sau" NextText="» Trước" QueryStringKey="Page" ResultsFormat="" ShowPageNumbers="True"></cc1:CollectionPager>
    </div>
    </div>
    <script>
